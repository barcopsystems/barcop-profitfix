...
const App = {
  ...
  _HUB_HELP: {
    'hub': { title: 'How the Hub Works', sections: [
      ...
      { h: 'Your biggest gain and worst drag', p: ['Which part of your Bar Cop Audit moved furthest up since the last one, and which fell furthest. Under each is the single measure inside that section that moved the most, with its own before and after. These need two audits on file before they can say anything.'] },
      { h: 'Needs you and Done this week', p: ['Needs you is the operational list: expiring certs and permits, projected overtime, cash flags, worst first, each a tap into the item it names. Done this week is the five recurring jobs, ticked from your real records rather than by hand, so a tick means the work is on file. It resets Monday.'] },
