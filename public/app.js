...
const TT = {
  ...
  defs: {
    ...
    'sh-cash-tol':    {t:'Cash Over/Short Tolerance',b:'The maximum dollar amount you treat as acceptable for a drawer to be off before flagging it. Over and Short in Profit Recovery uses this threshold to show green or red on each shift count.',e:'$10 is typical. Anything over $10 over or short triggers a flag'},
    ...
    'dr-bank':        {t:'Default Opening Bank',b:'The starting cash this register normally opens with. Cash Control shows it on the register tile as its standard bank, so anyone counting the drawer can see what it should have opened with. Leave it blank if the bank varies.',e:'Main bar opens with $300 every night'},
    'cs-tolerance':   {t:'Cash Variance Tolerance',b:'The most a drawer can be off before Bar Cop flags it. A count under this stays green; over it flags the count Over or Short on the register tile in Cash Control, on the Variances tab of Cash History, and on Over and Short in Profit Recovery.',e:'$10 tolerance: a drawer $7 short is fine, $14 short flags'},
...
const App = {
  ...
  _HUB_HELP: {
    'hub': { title: 'How the Hub Works', sections: [
      ...
      { h: 'The money line', p: ['Four figures across the top. Total Opportunity is every dollar your audits have surfaced that you have not closed yet. Recovered, in gold, is the proven dollars you have put back, counted only after a fix is marked implemented and measured. Trapped Cash is the dead and overstocked inventory you could free. Break-Even is the sales you need to clear your costs. The first three open the Fix system that works that money.'] },
