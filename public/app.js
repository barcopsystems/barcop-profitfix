...
const App = {
  ...
  _GLOBAL_OF_ACTION: { 'bar-cop-audit': 'audit', 'breakeven': 'books', 'books-home': 'books', 'books': 'books', 'weekly-pnl': 'books', 'year-end': 'books', 'operating-expenses': 'books', 'expense-history': 'books', 'permits': 'books', 'flowmap': 'flowmap' },
  ...
  _HUB_HELP: {
    'hub': { title: 'How the Hub Works', sections: [
      ...
      { h: 'The Where You Stand card', p: ['Total Monthly Opportunity is every recovery and revenue dollar your audits have surfaced but you have not closed yet. Recovery Scoreboard, in gold, is the proven dollars you have actually put back, counted only after a fix is marked implemented and measured. Bar Cop Audit is your latest operation-health score. The Bar Cop Briefing button on this card writes a short read of the whole operation from your logged numbers, and you can refresh it anytime.'] },
      { h: 'Audit Scores', p: ['Your Profit, Revenue, and Cash audit scores side by side, each with its score bar, the leak or opportunity it carries per week, the change since the last audit, and a Run Audit button. Run them whenever you want a fresh read to keep the trend honest.'] },
