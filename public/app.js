...
const TT = {
  ...
  defs: {
    ...
    'rd-vendor':      {t:'Vendor',b:'The distributor this delivery came from. Bar Cop logs the delivery and any price change against this vendor, so Vendor Watch and any credit claim point at the right account.',e:'Republic National, Sysco, your local craft beer rep'},
    'rd-date':        {t:'Date',b:'The day the delivery landed. This dates the stock coming in and lines your cost up with the right week on your usage and variance reports.',e:'Set it to the date on the invoice, not the day you log it'},
    'rd-invoice':     {t:'Invoice Number',b:'The invoice number off the paperwork the driver hands you. Optional, but it ties this delivery to the invoice if you ever have to chase a credit.',e:'INV-48217'},
    'rd-driver':      {t:'Driver',b:'Who dropped it off. Optional. Handy when something is short or wrong and you need to remember who was on the truck.',e:'The route driver name or number off the invoice'},
    'rd-by':          {t:'Received By',b:'Who on your team checked this delivery in. Bar Cop defaults to the manager on the active shift. This is your accountability trail if a count comes up short later.'},
    'rd-order':       {t:'Open Order',b:'An order you placed through Bar Cop that has not been received yet. Pick it and every line pre-fills with what you ordered, so you just confirm against the invoice. Bar Cop marks the order Received when you save.',e:'Leave it on walk-in delivery if there is no order on file'},
    'rd-notes':       {t:'Notes',b:'Anything worth remembering about this delivery. Optional.',e:'Two cases of limes looked rough, told the rep'},
    'rd-prod':        {t:'Product',b:'The item off your inventory list that this invoice line is for. Picking it pulls in your current cost so Bar Cop can spot a price change.',e:'Match each invoice line to the product you stock'},
    ...
    'rd-ext':         {t:'Extended',b:'Qty times unit price for this line. Bar Cop figures it for you so you can check each line total against your invoice.',e:'5 cases at $32.40 = $162.00 extended'},
  },
  show(icon) {
