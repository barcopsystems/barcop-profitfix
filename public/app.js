...
const TT = {
  ...
  defs: {
    ...
    'ic-serving-sizes': {t:'Other Sizes Sold',b:'The other ways this same bottle or keg sells, beyond your standard pour above. A draft sold as a 12 oz, a 16 oz, and a 60 oz pitcher. A wine sold by the glass and by the bottle. A liquor with a happy hour pour. Each size carries its own price and shows its own pour cost, because a bigger or discounted size is a different margin. Your shelf is still counted as one pool; this just captures the extra price points so each size reads honest. To sell a whole bottle, set the size equal to the bottle size.',e:'Draft: 16 oz at $7 standard, plus a 60 oz pitcher at $18 added here'},
    ...
    'vr-std-liquor':  {t:'Liquor Standard',b:'Liquor is poured by the ounce, so a little variance is normal from over-pour and spillage. This stays tight on purpose: anything over your Flag line is likely heavy free-pouring or theft. Set OK and Flag to your own pour discipline.'},
    'vr-std-wine':    {t:'Wine Standard',b:'Wine by the glass carries a touch more variance than liquor because of the last glass in the bottle. Set the bands to match how generously your team pours.'},
    'vr-std-draft':   {t:'Draft Standard',b:'Draft runs the widest because foam, line cleaning, and keg ends all cost ounces. A healthy tap system stays under your OK line. Loosen or tighten to match your equipment.'},
    'vr-std-bottle':  {t:'Bottle Beer Standard',b:'Bottle beer is simple bottle-in, bottle-out, so there is no pour variance to forgive. Bar Cop flags the moment this many bottles are unaccounted for, after comps and waste come out. Lower it to 1 to catch every missing bottle, or raise it to allow for honest miscounts.'},
    'vr-std-misc':    {t:'Mixer Standard',b:'Mixers are measured by eye in the quart, so the band is wider. Big gaps point to waste or a recipe that has drifted from the pour. Adjust to taste.'},
    'vr-std-food':    {t:'Food Standard',b:'Food carries real yield and trim loss, but over-portioning is a true cost leak. Tighten or loosen the bands to match how tightly your kitchen portions.'},
  },
  show(icon) {
