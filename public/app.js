...
const TT = {
  ...
  defs: {
    ...
    'il-type':        {t:'What’s Stored Here',b:'Whether this location holds bar product, kitchen product, or both. It filters the product list so a bar location never shows food and a kitchen location never shows liquor. Set it to Both for a spot that holds a mix.',e:'A walk-in cooler that holds beer and produce = Bar & Kitchen'},
