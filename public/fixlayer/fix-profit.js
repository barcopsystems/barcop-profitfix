    ...
    process: {
      steps: [
        ...
        { kind: 'result', target: 'audit-tracker', targetLabel: 'Profit Audit',
          ...
          detail: 'Open the Profit Audit and read the Pour and Bar Cost section. It carries your pour cost against target and the dollar gap, monthly and annual.' },
    ...
    process: {
      steps: [
        ...
        { kind: 'action', target: 'sc-void-comp', targetLabel: 'Void and Comp Log',
          ...
          detail: 'Drop your POS void and comp report at the Shift weekly close and the whole week lands with the server already on each line. No export? Then log every void, comp, and no-sale in the Void and Comp Log against the server who rang it, with an honest Reason. The give-aways read as loss; Staff Meal and Shift Drink post as a cost line.' },
        ...
        { kind: 'action', target: 'sc-cash-control', targetLabel: 'Cash Control',
          title: 'Reconcile your cash drawers',
          detail: 'Drop your POS cash report at the Shift weekly close and every drawer for the week lands at once. No cash export? Then count each drawer against expected POS cash at end of shift in Cash Control and log the over or short. Either way, watch consistent overs as closely as consistent shorts.' },
    ...
    process: {
      steps: [
        ...
        { kind: 'result', target: 'audit-tracker', targetLabel: 'Profit Audit',
          ...
          detail: 'Open the Profit Audit and read the Food Cost section. It carries your food cost against target and the dollar gap, monthly and annual.' },
