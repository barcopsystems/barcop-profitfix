    ...
    process: {
      steps: [
        ...
        { kind: 'result', target: 'reports', targetLabel: 'Reports and History',
          ...
          detail: 'Each week, open Reports and History with the kitchen manager. The weekly table shows food cost against target and the dollar gap. Cross-reference it against the waste sheet and the portion audit findings from the past week, and set one specific action with a named owner.' },
        { kind: 'action', target: 'recipe-library', targetLabel: 'Recipe Library',
