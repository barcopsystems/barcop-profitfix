...
S.CashAudit = {
  ...
  showHowTo() {
    App.showHelpModal('How the Cash Audit Works', [
      ...
      { h: 'Action Items', p: ['Each audit ranks what to work first by where you are weakest, and each item names the work and what freeing it is worth. Run it whenever you want a fresh read and watch the score climb as you free the cash and tighten the cycle.'] }
    ]);
  }
};
