  ...
  SECTIONS: [
    { t: 'Getting Started', qa: [
      ...
      { q: 'Do I need every screen?',
        a: 'No. The value comes from a few things: your Control data feeding the cost numbers, a Profit Audit for the baseline, and confirming each week in Close The Week. Recipe Summary, Loss Prevention, and Over and Short are read-only diagnosis views that come alive as Control data builds. You do not enter data in them; they read what you already logged in Control.' },
