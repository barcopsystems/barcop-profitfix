  ...
  SECTIONS: [
    ...
    { t: 'Loss, Cash, and Vendors', qa: [
      { q: 'What does Loss Prevention show?',
        a: 'A live read of the last seven days of loss signals: voids and comps without authorization, drawer shorts, flagged spot checks, large comps over your threshold without a manager, and any confirmed theft. There is no score here. It is a working list of what flagged and what each item costs, so you act on the pattern instead of a number. Severe flags also push to the Hub and to Open the Floor in Shift Control.' },
