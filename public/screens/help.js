...
S.Help = {
  ...
  SECTIONS: [
    ...
    { t: 'Audit and Fix', qa: [
      ...
      { q: 'How does Bar Cop measure a gap closing?',
        a: 'Each gap on the audit names the work and what closing it is worth. Measuring does not wait on you: the fix starts on its own the first time you take a tracked action on that gap, like a count logged or a recipe costed, and Bar Cop dates it from that action. From there Bar Cop measures that gap\'s weekly number against your own first weeks, and the movement is what shows on the Recovery Scoreboard.' },
