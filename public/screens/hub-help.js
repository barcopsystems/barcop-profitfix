...
S.HubHelp = {
  ...
  SECTIONS: [
      { t: 'About Bar Cop', qa: [
        { q: 'What is Bar Cop?',
          a: 'Bar Cop runs on a loop: log it, close the week, get scored, go fix what the score found. You log what happened as it happens. Inventory holds your counts, deliveries and ordering. The Floor holds your schedules, hours, the safe and the shift. Events holds your bookings. Then you close the week under The Week, and that confirmed week is the record everything else reads. Run Audit scores it: an Operations audit on how the place is being run, plus Profit, Revenue and Cash audits that put a dollar figure on every gap and rank them biggest first. Books turns the same records into your statements, your break-even and your forecasts. The fixing happens on your floor, not in an app. You work the biggest gap, close the next week, and Bar Cop measures the change against your own baseline, so the Hub shows what actually came back rather than what was promised.' },
        { q: 'How do the sections fit together?',
          a: 'You log once and everything else reads it. Counts and deliveries in Inventory set your cost of goods. Hours and the safe under The Floor set your labor cost and your cash variance. Bookings under Events land in the weeks they belong to. Close The Week confirms the week, and that confirmed week is what every score and every statement is built from. Run Audit reads it and puts dollars on the gaps. Books reads the same records for your P&L, your break-even and your forecasts. The Hub pulls the headline numbers off all of it so you are not opening eight screens to see where you stand. Nothing gets entered twice.' },
        { q: 'Where do I start?',
          a: 'When you first sign in, a short onboarding collects the essentials, your bar name, your annual sales, and your service periods, then drops you on the Hub. From there the fastest path is Run Audit for a day-one scored snapshot, then log your first week: a count in Inventory, your hours and your safe under The Floor. Every section opens to a guided empty state that walks you through its setup in context, so you are never staring at a blank page. Close the week under The Week and the numbers fill in from there.' },
        { q: 'Can I use Bar Cop on my phone behind the bar?',
          a: 'Yes. The screens that get used during a shift are built mobile-first, meaning they work on a phone propped behind the bar, a tablet on the counting cart, or a manager\'s tablet during a walkthrough. 48px touch targets, 16px text minimum, no horizontal scroll, auto-save the moment a value is entered. The mobile-first screens are Take Inventory, Receive Delivery, Spot Check and the Void and Comp Log under Inventory, plus Cash Control under The Floor. These are the screens you actually touch while running the floor, not while sitting at a desk. If your wifi flakes mid-count, Bar Cop keeps writing to local storage as you go. The next time you open it on a working connection, a sync banner offers to push the pending changes to the server. Nothing is lost when the connection drops in the middle of counting the well.' }
      ]},

      { t: 'The Hub, Audits, and What It Shows', qa: [
        { q: 'What is the Hub showing me?',
          a: 'The Hub is your home screen and the cross-system view, laid out in the owner\'s reading order. Four figures run across the top: Total Opportunity, the money your audits have surfaced that you have not closed yet; Recovered, the proven dollars you have put back, counted only after a fix is measured; Trapped Cash, the dead and overstocked inventory you could free; and Break-Even, the sales you need to clear your costs. The first three open the audit that found that money. Under them your Operations Audit panel shows your first score against today\'s and the points between, with the Profit, Revenue and Cash audits and the date each last ran. Where you were, where you are is a fixed two-week comparison of prime cost, labor, check average and weekly sales. Do this first names the single biggest money move across every audit, one item rather than a list, because Bar Cop has already done the ranking. Your biggest gain and your worst drag name the two operating numbers that moved furthest for and against you. Needs attention is the operational list, worst first: expiring certs and permits, projected overtime, cash flags. Done this week ticks the five recurring jobs off your real records and resets Monday.' },
        { q: 'What is the Operations Audit?',
          a: 'The Operations Audit is the executive read on your whole operation. It sits above every section and scores six operational areas on a 0 to 100 scale: Operational Discipline (are your daily and weekly procedures actually getting done), Cash Integrity (variance trend, drawer counts, cash drops), Inventory Execution (count frequency, vendor discrepancy resolution, spot check variance), Labor Hygiene (schedule adherence, callouts, overtime, certifications, coaching), Recovery Action (gaps surfaced versus fixes logged versus dollars recovered), and Operational Consistency (week-over-week variance in stable metrics). The audit also surfaces Top Operational Exposures (the items you need to address now) and Recurring Patterns (chronic issues showing up across rolling 90-day windows). Open it by clicking your Operations Audit score at the top of the Hub. Run it whenever you want a fresh read; it scores your trailing 30 days. There is no lock. It scores as soon as there is anything real to read and each sub-score fills in as you log more, showing Not Enough Data until then.' },
        { q: 'How is the Operations Audit different from the other three?',
          a: 'The Profit, Revenue and Cash audits are about money. They name the gaps where the operation is leaking revenue or running cost up, attach a dollar figure to each gap, and rank action items by annual impact. They answer where the money is going. The Operations Audit is about discipline. It scores whether the operation is being run well, whether the procedures are being followed, whether issues are being acted on. It answers whether the operation is being run with discipline. Both serve different purposes and both run whenever you want a fresh read, most operators run them together with the weekly close. Read them together. A weak Recovery score with a strong Operations Audit score means the leaks are structural, not operational. A weak Operations Audit score with a passable Recovery score means the operation is leaking ground that does not show up on the weekly P&L yet.' },
        { q: 'What does an audit do that the Hub does not?',
          a: 'The Hub shows you the current state. An audit scores the operation. It is a structured diagnostic on a 0 to 100 scale across every section it grades, written like a coaching report instead of a raw metric dump. It names each gap, attaches a dollar figure to it, and ranks the action items by annual impact. Run any of them as often as you want; it is included in your subscription. The recurring value of Bar Cop is the scored reports plus the recovered-dollar tracking in Where You Stand proving the work is paying off.' },
      ...
      { t: 'Your Account and Your Data', qa: [
        ...
        { q: 'Does Bar Cop connect to my POS?',
          a: 'Not through a live API connection yet. The bridge today is CSV and Excel import. Most POSes (Toast, Square, Lightspeed, Aloha) let you export a Sales by Item, Item Selection, or Product Mix report for any date range. Bar Cop\'s import screens read those exports directly. Upload the file, map the columns once on the mapping screen, the data lands. The Variance Report under Inventory reads a POS sales export and works out what you should have poured, against what your counts say you actually used. The product setup screens import your full menu off a vendor order guide or POS item list in one shot. Sales is the one POS number Bar Cop reads as ground truth, and it goes in under The Week when you close, day by day, alongside your hours, tips and cash. Every audit and every statement reads that confirmed week, so there is no double entry across the rest of Bar Cop.' },
        { q: 'Can I export my data?',
          a: 'Yes. Open Settings, then Backup, and use Export Backup. The export pulls every record from every section into one JSON file: settings, targets, weekly numbers, all four audits, recipes, your money out log, permits, and your full Inventory, Floor and Events records. Keep a copy offsite as your own backup. Restore from Backup reads the same file back in if you ever need to roll back or move accounts. Export takes under a second on most accounts.' },
