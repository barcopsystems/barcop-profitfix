...
S.TrafficEmail = {
  ...
  draw() {
    ...
    const formCard = '<div class="card">'
      ...
      + '<div class="f" style="width:160px;"><label>Last Send Date</label><input type="date" id="em-last" value="' + esc(prof.email_last_send || '') + '"/></div>'
      + '<div class="f" style="width:190px;"><label>Send Frequency</label><select id="em-freq">' + freqOpts + '</select></div>'
      + '<div class="f" style="width:230px;"><label>List Growth Mechanism</label><select id="em-growth">' + growthOpts + '</select></div>'
      + '</div>'
