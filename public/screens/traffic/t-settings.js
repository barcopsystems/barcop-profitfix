      ...
      <div id="ts-tab-general">
        <div class="settings-section"><div class="settings-title">Your Bar</div>
          <div class="card"><div class="form-row" style="gap:16px;">
            ...
            <div class="f" style="width:80px;"><label>State / Province</label><input type="text" id="ts-state" value="${esc((s.city_state||'').split(',')[1]?.trim()||'')}" placeholder="TX"/></div>
          </div></div>
        </div>
