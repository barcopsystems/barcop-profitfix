...
S.TrafficWebsite = {
  ...
  draw() {
    ...
    const formCard = '<div class="card">'
      ...
      + '<div class="f" style="width:200px;"><label>Avg Session Duration</label><div class="fw"><input class="suf" type="number" id="web-dur" value="' + (dur != null ? dur : '') + '" min="0"/><span class="suf">sec</span></div></div>'
      + '<div class="f" style="width:200px;"><label>Top Traffic Source</label><select id="web-source">' + srcOpts + '</select></div>'
      + '</div>'
