...
S.TrafficSearch = {
  ...
  draw() {
    ...
    const formCard = '<div class="card">'
      ...
      + '<div class="f" style="width:230px;"><label>Primary Local Keyword</label><input type="text" id="srch-keyword" value="' + esc(keyword) + '" placeholder="austin sports bar"/></div>'
      + '<div class="f" style="width:170px;"><label>Citation Count Estimate</label><div class="fw"><input class="suf" type="number" id="srch-citations" value="' + (citations != null ? citations : '') + '" min="0"/><span class="suf">listings</span></div></div>'
      + '</div>'
