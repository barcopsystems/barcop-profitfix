...
S.TrafficThisWeek = {
  ...
  step2() {
    ...
    return '<div class="card"><div class="card-title">Google and Yelp</div>'
      ...
      + '<div class="f" style="width:150px;"><label>Google Rating ' + tt('t-google-rating') + '</label><div class="fw"><input class="suf" type="number" id="ttw-gr" value="' + esc(this.draft.google_rating) + '" step="0.1" min="1" max="5" oninput="S.TrafficThisWeek.calcGBP()"/><span class="suf">★</span></div></div>'
      + '<div class="f" style="width:150px;"><label>Total Google Reviews</label><div class="fw"><input class="suf" type="number" id="ttw-gt" value="' + esc(this.draft.google_total) + '" oninput="S.TrafficThisWeek.calcGBP()"/><span class="suf">total</span></div></div>'
      + '<div class="f" style="width:150px;"><label>New Reviews/Mo ' + tt('t-review-vel') + '</label><div class="fw"><input class="suf" type="number" id="ttw-nr" value="' + esc(this.draft.new_reviews) + '" oninput="S.TrafficThisWeek.calcGBP()"/><span class="suf">/mo</span></div></div>'
      + '<div class="f" style="width:150px;"><label>Response Rate ' + tt('t-response-rate') + '</label><div class="fw"><input class="suf" type="number" id="ttw-rr" value="' + esc(this.draft.response_rate) + '" step="1" min="0" max="100" oninput="S.TrafficThisWeek.calcGBP()"/><span class="suf">%</span></div></div>'
      + '<div class="f" style="width:150px;"><label>Yelp Rating</label><div class="fw"><input class="suf" type="number" id="ttw-yr" value="' + esc(this.draft.yelp_rating) + '" step="0.1" min="1" max="5"/><span class="suf">★</span></div></div>'
      + '<div class="f" style="width:150px;"><label>Total Yelp Reviews</label><div class="fw"><input class="suf" type="number" id="ttw-yt" value="' + esc(this.draft.yelp_total) + '"/><span class="suf">total</span></div></div>'
      + '</div>'
      + '<div class="calc">'
  ...
  step5() {
    return '<div class="card"><div class="card-title">Delivery Platforms</div>'
      + '<div class="form-row" style="gap:16px;">'
      + '<div class="f" style="width:130px;"><label>DoorDash Active</label>' + this.yesNo('ttw-dda', this.draft.dd_active) + '</div>'
      + '<div class="f" style="width:140px;"><label>DoorDash Rating</label><div class="fw"><input class="suf" type="number" id="ttw-dd" value="' + esc(this.draft.dd_rating) + '" step="0.1" min="1" max="5" oninput="S.TrafficThisWeek.calcDelivery()"/><span class="suf">★</span></div></div>'
      + '<div class="f" style="width:130px;"><label>Uber Eats Active</label>' + this.yesNo('ttw-uea', this.draft.ue_active) + '</div>'
      + '<div class="f" style="width:140px;"><label>Uber Eats Rating</label><div class="fw"><input class="suf" type="number" id="ttw-ue" value="' + esc(this.draft.ue_rating) + '" step="0.1" min="1" max="5" oninput="S.TrafficThisWeek.calcDelivery()"/><span class="suf">★</span></div></div>'
      + '<div class="f" style="width:130px;"><label>Grubhub Active</label>' + this.yesNo('ttw-gha', this.draft.gh_active) + '</div>'
      + '<div class="f" style="width:140px;"><label>Grubhub Rating</label><div class="fw"><input class="suf" type="number" id="ttw-gh" value="' + esc(this.draft.gh_rating) + '" step="0.1" min="1" max="5" oninput="S.TrafficThisWeek.calcDelivery()"/><span class="suf">★</span></div></div>'
      + '</div>'
      + '<div class="calc">'
  ...
  step6() {
    ...
    return '<div class="card"><div class="card-title">Email and Loyalty</div>'
      + '<div class="form-row" style="gap:16px;">'
      + '<div class="f" style="width:170px;"><label>Email List Size</label><div class="fw"><input class="suf" type="number" id="ttw-els" value="' + esc(this.draft.email_list_size) + '"/><span class="suf">contacts</span></div></div>'
      + '<div class="f" style="width:160px;"><label>Emails Sent This Month</label><input type="number" id="ttw-esnt" value="' + esc(this.draft.emails_sent) + '"/></div>'
      + '<div class="f" style="width:160px;"><label>Email Open Rate</label><div class="fw"><input class="suf" type="number" id="ttw-eor" value="' + esc(this.draft.email_open_rate) + '" step="1" min="0" max="100" oninput="S.TrafficThisWeek.calcEmail()"/><span class="suf">%</span></div></div>'
      + '<div class="f" style="width:130px;"><label>Loyalty Program</label>' + this.yesNo('ttw-loya', this.draft.loyalty_active) + '</div>'
      + '<div class="f" style="width:160px;"><label>Loyalty Members</label><div class="fw"><input class="suf" type="number" id="ttw-loym" value="' + esc(this.draft.loyalty_members) + '"/><span class="suf">members</span></div></div>'
      + '</div>'
      + '<div class="calc">'
