...
S.TrafficThisWeek = {
  ...
  step2() {
    ...
    return '<div class="card"><div class="card-title">Google and Yelp</div>'
      ...
      + '<div class="f" style="width:130px;"><label>Total Google Reviews</label><div class="fw"><input class="suf" type="number" id="ttw-gt" value="' + esc(this.draft.google_total) + '" oninput="S.TrafficThisWeek.calcGBP()"/><span class="suf">total</span></div></div>'
      ...
      + '<div class="f" style="width:130px;"><label>Yelp Rating</label><div class="fw"><input class="suf" type="number" id="ttw-yr" value="' + esc(this.draft.yelp_rating) + '" step="0.1" min="1" max="5"/><span class="suf">★</span></div></div>'
      + '<div class="f" style="width:130px;"><label>Total Yelp Reviews</label><div class="fw"><input class="suf" type="number" id="ttw-yt" value="' + esc(this.draft.yelp_total) + '"/><span class="suf">total</span></div></div>'
      + '</div>'
      + '<div class="calc">'
  ...
  step5() {
    return '<div class="card"><div class="card-title">Delivery Platforms</div>'
      + '<div class="form-row" style="gap:16px;">'
      + '<div class="f" style="width:105px;"><label>DoorDash Active</label>' + this.yesNo('ttw-dda', this.draft.dd_active) + '</div>'
      + '<div class="f" style="width:125px;"><label>DoorDash Rating</label><div class="fw"><input class="suf" type="number" id="ttw-dd" value="' + esc(this.draft.dd_rating) + '" step="0.1" min="1" max="5" oninput="S.TrafficThisWeek.calcDelivery()"/><span class="suf">★</span></div></div>'
      + '<div class="f" style="width:105px;"><label>Uber Eats Active</label>' + this.yesNo('ttw-uea', this.draft.ue_active) + '</div>'
      + '<div class="f" style="width:125px;"><label>Uber Eats Rating</label><div class="fw"><input class="suf" type="number" id="ttw-ue" value="' + esc(this.draft.ue_rating) + '" step="0.1" min="1" max="5" oninput="S.TrafficThisWeek.calcDelivery()"/><span class="suf">★</span></div></div>'
      + '<div class="f" style="width:105px;"><label>Grubhub Active</label>' + this.yesNo('ttw-gha', this.draft.gh_active) + '</div>'
      + '<div class="f" style="width:125px;"><label>Grubhub Rating</label><div class="fw"><input class="suf" type="number" id="ttw-gh" value="' + esc(this.draft.gh_rating) + '" step="0.1" min="1" max="5" oninput="S.TrafficThisWeek.calcDelivery()"/><span class="suf">★</span></div></div>'
      + '</div>'
      + '<div class="calc">'
