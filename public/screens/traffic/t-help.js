    ...
    const sections = [
      ...
      { t: 'Traffic Audit', qa: [
        ...
        { q: 'How often should I request an audit?',
          a: 'One audit per month is included with your Traffic Recovery subscription. Monthly is the right frequency. It gives you enough time to act on the prior audit before you score yourself again. Request it at the same point each month so the data periods line up and the score trend reflects what your work actually moved. Your first audit is your baseline. Your second audit, after 30 days of entering weekly data and working through the Getting Started checklist, shows the gap your work has already closed. That score movement is the most useful number in the system.' },
      ]},
      { t: 'Settings', qa: [
