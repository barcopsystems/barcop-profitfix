    ...
    const sections = [
      ...
      { t: 'Traffic Audit', qa: [
        ...
        { q: 'How often should I request an audit?',
          a: 'One audit every 30 days from your last audit. The audit screen shows a countdown to your next available audit after you generate one. The 30-day pace gives you enough time to act on the prior audit before you score yourself again. Your first audit is your baseline. Your second audit, 30 days later after working through the Getting Started checklist, shows the gap your work has already closed. That score movement is the most useful number Bar Cop gives you.' },
      ]},
      { t: 'Settings', qa: [
