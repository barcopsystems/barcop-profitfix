    ...
    const sections = [
      ...
      { t: 'Delivery Platforms', qa: [
        ...
        { q: 'How often should I check the platform dashboards?',
          a: 'Weekly. Ten minutes. Rating and order volume change every week. An operator who checks monthly misses problems that compound for weeks. Respond to every new review with the same standard you use for Google, and check for any item the platform auto-flagged or removed. The Delivery Platforms screen tracks rating and order volume over time so the trend is visible without you having to remember last week\'s numbers.' }
      ]},
