...
S.TrafficHelp = {
  ...
  SECTIONS: [
    { t: 'Getting Started', qa: [
      ...
      { q: 'Where do I start?',
        a: 'Open Online Tracker. It puts every area (Google Business, website, reviews, search, social, delivery, email) on one page with your live numbers, a Strong, Watch, or Weak read, and the setup you control. Run the Traffic Audit on day one for a scored baseline. Then log This Week so your ratings, reviews, sessions, and orders start building a trend. Fix the weakest area first, the one Online Tracker flags.' },
