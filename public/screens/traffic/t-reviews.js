...
S.TrafficReviews = {
  ...
  draw() {
    ...
    const inputsCard = '<div class="card">'
      ...
      + '<div class="f" style="width:200px;"><label>Most Recent Review Age</label><div class="fw"><input class="suf" type="number" id="rev-age" value="' + esc(String(age)) + '" min="0"/><span class="suf">days ago</span></div></div>'
      + '</div>'
      + '<div class="f" style="margin-bottom:14px;"><label>Negative Patterns Noted</label>'
