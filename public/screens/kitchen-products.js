...
S.KitchenProducts = {
  ...
  showImport() {
    ...
    fa.innerHTML = '<div class="divider"></div><div class="card">'
      ...
      + 'Upload a CSV or Excel file from your POS, inventory system, or supplier. Match your columns to the right fields. Products import instantly — fill in any missing data afterwards.</div>'
