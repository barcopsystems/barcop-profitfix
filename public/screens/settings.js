  ...
  async loadSample() {
    ...
    App.data.audits = [
      mkAudit('profit', { date: dateStr(74), generated_at: daysAgoISO(74), raw: {
        ...
        S1_NARRATIVE: 'Bar pour cost ran 29.4% against a 22% target — the single largest profit leak in this audit. Free pouring with no jiggers and no costed recipes means every drink is a guess.',
        ...
        S4_FINDING: 'Sampled invoices show price drift and at least two short deliveries that were paid in full — roughly $1,140 of monthly exposure with no backup vendor leverage.',
        ...
        S5_NARRATIVE: 'Prime cost hit 70.3% against a 60% target — 10 points of margin gone before a single fixed cost is paid.',
    ...
    App.data.revenue_audits = [
      mkAudit('revenue', { date: dateStr(74), generated_at: daysAgoISO(74), raw: {
        ...
        S3_NARRATIVE: 'The menu carries seven Dogs — low-margin, low-popularity items — and only three Stars.',
        ...
        S4_NARRATIVE: 'The spread between the top and bottom server check average is $17.20 — a coaching gap, not a talent gap.',
