  ...
  async loadSample() {
    ...
    App.data.audits = weeklySeries('profit', {
      90: mkAudit('profit', { date: dateStr(90), generated_at: daysAgoISO(90), raw: {
        ...
        S3_SCORE: 28, S3_INV_VARIANCE_DOLLAR: 3000, S3_INV_VARIANCE_PCT: 7.1, S3_COUNT_CADENCE: 'Monthly or less',
      ...
      60: mkAudit('profit', { date: dateStr(60), generated_at: daysAgoISO(60), raw: {
        ...
        S3_SCORE: 42, S3_INV_VARIANCE_DOLLAR: 2000, S3_INV_VARIANCE_PCT: 5.0, S3_COUNT_CADENCE: 'Every other week',
      ...
      30: mkAudit('profit', { date: dateStr(30), generated_at: daysAgoISO(30), raw: {
        ...
        S3_SCORE: 55, S3_INV_VARIANCE_DOLLAR: 1100, S3_INV_VARIANCE_PCT: 3.2, S3_COUNT_CADENCE: 'Weekly',
      ...
      0: mkAudit('profit', { date: dateStr(0), generated_at: daysAgoISO(0), raw: {
        ...
        S3_SCORE: 68, S3_INV_VARIANCE_DOLLAR: 620, S3_INV_VARIANCE_PCT: 2.0, S3_COUNT_CADENCE: 'Weekly',
