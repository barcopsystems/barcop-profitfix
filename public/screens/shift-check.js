...
S.ShiftCheck = {
  ...
  render(container, actions) {
    ...
    container.innerHTML = '<div class="screen">'
      ...
      + '<div class="f" style="width:120px;flex-shrink:0;"><label>Revenue '+tt('bar-revenue')+'</label><div class="fw" style="width:100%;"><span class="pre">$</span><input class="pre" type="number" id="sc-rev" placeholder="" style="width:100%;" /></div></div>'
      + '<div class="f" style="width:120px;flex-shrink:0;"><label>COGS '+tt('shift-cogs')+'</label><div class="fw" style="width:100%;"><span class="pre">$</span><input class="pre" type="number" id="sc-cogs" placeholder="" style="width:100%;" /></div></div>'
