...
S.RecoveryExperiments = {
  ...
  showHowTo() {
    ...
    App.showHelpModal('How Experiments Work', [
      ...
      { h: 'It measures, it does not double-count', p: ['An experiment reports a metric lift only, never recovered dollars, so it never double-counts against your measured recovery. It is separate from your audits too: an audit prescribes the work, while an experiment is a change you decided to make on your own. Mark Complete to file one once you have your answer, or Delete one started by mistake.'] }
    ]);
  }
};
