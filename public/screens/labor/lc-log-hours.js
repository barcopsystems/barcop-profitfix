...
S.LaborLogHours = {
  ...
  showHowTo() {
    App.showHelpModal('How Logging Hours Works', [
      { p: ['This is where actual hours worked get recorded. Logged hours feed your weekly labor cost, prime cost, and revenue per labor hour across your Profit and Revenue audits, so what you enter here drives the numbers everywhere else.'] },
