  ...
  SECTIONS: [
    ...
    { t: 'Pay Periods', qa: [
      ...
      { q: 'How does tip-credit compliance work?',
        a: 'In jurisdictions that allow tip credit, an employer can pay a tipped wage below the standard minimum wage as long as tips bring the staff member up to or over the state minimum. Set your state minimum wage on Wage Policy, under Setup. Mark tipped positions with the tipped flag. Payroll Export calculates each tipped staff member\'s effective hourly rate (base wage plus tips divided by hours) and flags any week that fell below the state minimum. Pay Periods detail also shows the count of tipped employees below minimum at the top of the week with the reminder to make up the difference before payroll runs. This is a planning aid, not legal or payroll advice; verify the rules for your jurisdiction.' },
