  ...
  SECTIONS: [
    ...
    { t: 'Certs & Coaching', qa: [
      ...
      { q: 'Who can see coaching log entries?',
        a: 'The coaching log lives on each person\'s page, so anyone you give access to the Staff Roster screen can see it, along with that person\'s profile, certifications, and training records. Access follows the role permissions you set under Settings: Admin has full access, Viewer is read-only, and a Staff or Manager role sees it only if you grant the Staff Roster screen. Treat the log like any personnel file and keep Staff Roster access limited to the people who should be reading HR notes. Retain entries as long as your jurisdiction requires for HR records.' },
