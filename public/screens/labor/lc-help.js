...
S.LaborHelp = {
  ...
  SECTIONS: [
    { t: 'Getting Started', qa: [
      ...
      { q: 'Where do I start?',
        a: 'Four steps get Labor Control producing real numbers. First, set up your Staff Positions (bartender, server, line cook) with a department, a default wage, and the tipped setting where it applies. Second, build the Staff Roster, assigning each person a position and capturing any certifications. Third, build the first week in Build Schedule. Fourth, log the hours people actually worked in Log Hours, by hand or by import. Each screen carries its own step-by-step directions on the info "i", and Labor opens to a guided empty state until your roster and first week are in.' },
