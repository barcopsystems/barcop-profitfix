  ...
  render(container, actions) {
    ...
    const sections = [
      ...
      { t: 'Tips', qa: [
        ...
        { q: 'What does Print Tip Sheet do?',
          a: 'Prints a paper tip sheet for the bar or floor to fill in by hand during a shift, then the manager enters totals into Bar Cop after close. Columns for date, server, cash tips, credit tips, total. The paper-to-digital bridge is the same pattern as the 86 List and the Void/Comp Log: operations happen on paper during service, data lands in Bar Cop after close.' },
      ...
      { t: 'Pay Periods', qa: [
        ...
        { q: 'How does tip-credit compliance work?',
          a: 'In jurisdictions that allow tip credit, an employer can pay a tipped wage below the standard minimum wage as long as tips bring the staff member up to or over the state minimum. Set your state minimum wage in Hub Settings. Mark tipped positions with the tipped flag. The Payroll CSV calculates each tipped staff member\'s effective hourly rate (base wage plus tips divided by hours) and flags any week that fell below the state minimum. Pay Periods detail also shows the count of tipped employees below minimum at the top of the week with the warning to make up the difference before payroll runs.' },
