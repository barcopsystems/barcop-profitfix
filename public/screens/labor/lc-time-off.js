  ...
  renderList() {
    ...
    if (ordered.length === 0) {
      below = '<div class="card" style="overflow-x:auto;margin-top:24px;"><table class="row-list"><thead><tr>'
        ...
        + '</tr></thead><tbody><tr><td colspan="5" style="color:var(--t3);">No time off logged yet. Use the form above to record requested days off, vacation, and sick leave.</td></tr></tbody></table></div>';
    } else {
