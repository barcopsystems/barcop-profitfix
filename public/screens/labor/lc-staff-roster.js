...
S.LaborStaffRoster = {
  ...
  showHowTo() {
    App.showHelpModal('How the Staff Roster Works', [
      { p: ['The roster is your team: every staff member, their position, wage, and status. It is the source for scheduling, hours, tips, and the Server Check list, so getting it right here means it is right everywhere.'] },
