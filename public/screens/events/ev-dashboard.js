...
S.EventsDashboard = {
  ...
  whereYouStand(st) {
    ...
    /* The per-section Bar Cop Briefing button is gone from here. There is ONE whole-bar read now,
       The Rail, in the top bar on every page — so the header goes back to a plain card title with
       no flex row to hold a control. */
