...
S.EventsBookings = {
  ...
  showHowTo() {
    App.showHelpModal('How Event Booking Works', [
      ...
      { h: 'Deposit and Balance', p: ['Once a booking is Booked, log the deposit you took and mark it paid. The balance is the quoted total minus the deposit; mark it paid when the money lands. Deposits still owed roll up into Deposits Due on the strip at the top of this page, and booked balances feed your Cash Forecast as money coming in.'] },
