...
S.AuditTracker = {
  ...
  _drawAudit(audit) {
    ...
    this.container.innerHTML = '<div class="screen">'
      ...
      + AuditUI.recoverStrip(audit, 'profit')
  ...
  showHowTo() {
    App.showHelpModal('How the Profit Audit Works', [
      ...
      { h: 'The steps', p: ['1. Get your week in: confirm the week in Close The Week and keep your counts, hours and drawer counts logged. 2. Generate. If no week is closed yet, enter last week\'s bar and food sales when Bar Cop asks. Sections with no data show N/A and fill in as you log more.'] },
