  ...
  showHowTo() {
    App.showHelpModal('How the Variance Report Works', [
      ...
      { h: 'Variance Standards (You Set These)', p: [
        ...
        'By the Bottle (bottle beer, wine by the bottle, champagne splits) is the deep-dive standard for bottle counts: it flags the moment a single bottle is unaccounted, because it is bottle-in, bottle-out. The Bottle Beer percent above is the Quick Check version, where bottle beer reads as a category in dollars.' ] },
      { h: 'History', p: ['Every run is saved against its count period, so the History tab shows your variance trend period over period, and you can reopen any past run by stepping through periods with the arrows up top, or by clicking a row in History. Re-running a period replaces it, and because standards are never frozen into a saved run, tightening a standard re-judges your whole history consistently.'] }
    ]);
  },
