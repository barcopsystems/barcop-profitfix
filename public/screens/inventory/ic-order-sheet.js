...
S.InventoryOrderSheet = {
  ...
  showHowTo() {
    App.showHelpModal('How the Order Sheet Works', [
      { p: ['The Order Sheet turns your counts and deliveries into orders. Anything sitting below par shows up under the vendor you buy it from, already filled to the quantity that brings you back to par. You can also build an order from scratch at the bottom.'] },
