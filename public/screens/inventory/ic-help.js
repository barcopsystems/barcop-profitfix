    ...
    const sections = [
      ...
      { t: 'Operations', qa: [
        { q: 'What is the Operations section for?',
          a: 'Three logs that capture inventory events outside of normal counts, deliveries, and orders: Transfer Log, Empties Log, and Adjustment Log. They give you an accountability record for every bottle that moves between locations, every container that leaves the building, and every documented loss or found-stock entry. None of them change product totals on their own (a transfer just moves location, an adjustment is a documented attribution), but they feed Theft Risk, Books, and the audit trail your bookkeeper expects.' },
