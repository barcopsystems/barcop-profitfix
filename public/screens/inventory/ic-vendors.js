...
S.InventoryVendors = {
  ...
  formFieldsHTML(v) {
    ...
    return '<div class="form-row" style="gap:12px;">'
      ...
      + '<div class="f" style="flex:0.7 1 78px;"><label>Terms</label>' + App.customSelect({ id: 'iv-terms', builtin: this.TERMS.filter(t => t), existing: this.vendors().map(x => x.payment_terms), selected: (v ? v.payment_terms : ''), blank: true }) + '</div>'
