...
S.BarProducts = {
  ...
  renderReadOnly() {
    ...
    let body;
    if (prods.length === 0) {
      body = '<div class="empty"><div class="empty-title">No bar products in Inventory Control</div>'
        + '<div class="empty-sub">Bar products are managed in Inventory Control now. Add Liquor, Wine, '
