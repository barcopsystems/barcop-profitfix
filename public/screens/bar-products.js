...
S.BarProducts = {
  ...
  showImport() {
    ...
    fa.innerHTML = '<div class="divider"></div><div class="card">'
      ...
      + 'Upload a CSV or Excel file exported from your POS system. The app will read your columns and let you match them to the right fields. '
      + 'Products will import instantly — you can fill in any missing data afterwards.</div>'
