    ...
    if (latest && latest.action_items && latest.action_items.length) {
      ...
      if (totalMonthly > 0) {
        ...
        gapTile = '<div class="card" style="margin-bottom:16px;">'
          + '<div style="font-size:9px;font-weight:700;letter-spacing:2.5px;text-transform:uppercase;color:var(--t3);margin-bottom:12px;">Revenue Recovery Gap Calculator</div>'
