...
S.RevenueReports = {
  render(container, actions) {
    ...
    container.innerHTML = '<div class="screen">'
      ...
      + '<div><div style="font-size:10px;font-weight:700;letter-spacing:1px;text-transform:uppercase;color:var(--t3);margin-bottom:4px;">Projected Annual Check Avg Opportunity</div><div style="font-size:22px;font-weight:800;color:' + (annualGap >= 0 ? 'var(--gold)' : 'var(--red)') + ';">' + (annualGap >= 0 ? '+' : '') + App.fmtCurrency(annualGap) + '</div><div style="font-size:11px;color:var(--t3);">vs target at current volume</div></div>'
      ...
      + (laborGapAnn ? '<div><div style="font-size:10px;font-weight:700;letter-spacing:1px;text-transform:uppercase;color:var(--t3);margin-bottom:4px;">Projected Annual Labor Opportunity</div><div style="font-size:22px;font-weight:800;color:' + (laborGapAnn <= 0 ? 'var(--gold)' : 'var(--red)') + ';">' + (laborGapAnn <= 0 ? '' : '+') + App.fmtCurrency(laborGapAnn) + '</div><div style="font-size:11px;color:var(--t3);">vs labor target</div></div>' : '')
      + '</div></div>'
