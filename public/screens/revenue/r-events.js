...
S.RevenueEvents = {
  ...
  renderRateCard(container, actions) {
    ...
    container.innerHTML = '<div class="screen"><div class="card">'
      ...
      + '<div style="font-size:12px;color:var(--t2);margin-bottom:16px;line-height:1.6;">Define your private dining packages. This replaces verbal quoting and ensures consistent pricing.</div>'
      ...
      + '</div>'
      + '<div class="form-row" style="gap:14px;margin-bottom:16px;">'
      + '<div class="f w-md"><label>Min Covers</label><input type="number" id="rrc-minc" placeholder="20"/></div>'
      + '<div class="f w-md"><label>Max Covers</label><input type="number" id="rrc-maxc" placeholder="60"/></div>'
      + '<div class="f w-md"><label>F&B Minimum</label><div class="fw"><span class="pre">$</span><input class="pre" type="number" id="rrc-fbmin" placeholder="0"/></div></div>'
  ...
  renderCateringCalc(container, actions) {
    container.innerHTML = '<div class="screen"><div class="card">'
      ...
      + '<div style="font-size:12px;color:var(--t2);margin-bottom:16px;line-height:1.6;">Build a catering quote on the fly. Enter your costs and target margin to get the right per-head price.</div>'
      + '<div class="form-row" style="gap:14px;margin-bottom:16px;">'
  ...
  showForm(container, actions) {
    container.innerHTML = '<div class="screen"><div class="card">'
      ...
      + '<div class="f w-md"><label>Covers</label><input type="number" id="rev-cov" placeholder="0"/></div>'
      + '<div class="f w-md"><label>F&B Minimum</label><div class="fw"><span class="pre">$</span><input class="pre" type="number" id="rev-fbmin" placeholder="0"/></div></div>'
      + '<div class="f w-md"><label>Actual Revenue</label><div class="fw"><span class="pre">$</span><input class="pre" type="number" id="rev-actual" placeholder="0"/></div></div>'
