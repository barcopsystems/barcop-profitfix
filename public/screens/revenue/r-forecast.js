...
S.RevenueForecast = {
  ...
  showHowTo() {
    App.showHelpModal('How Revenue Forecast Works', [
      ...
      { h: 'The Numbers', p: ['This Week and Next Week show the projected total, events included. Cover Goal is the guests you are projected to serve, which also feeds Build Schedule and the Pre-Shift Briefing. The projection below lists the next several weeks so you can see what is building.'] },
