...
S.RevenueForecast = {
  ...
  showHowTo() {
    App.showHelpModal('How Revenue Forecast Works', [
      ...
      { h: 'Forecast Accuracy', p: ['Once a week you forecast has its actual logged in This Week, it lands in the Forecast Accuracy table at the bottom: each row pairs your forecast against the actual, with the gap in dollars and percent. Average Error is how far off you have run across the matched weeks, and Matched Weeks counts how many pairs it has to work with. Export PDF saves the table. Watch it tighten as you learn your room.'] }
    ]);
  },
