...
S.RevenueForecast = {
  ...
  showHowTo() {
    App.showHelpModal('How Revenue Forecast Works', [
      ...
      { h: 'It Runs Itself', p: ['Every week you confirm sharpens the projection, and every event you book raises the week it lands on. This page is a read-only look at what is coming.'] },
