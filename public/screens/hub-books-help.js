  ...
  SECTIONS: [
    ...
    { t: 'Connections', qa: [
      { q: 'Where do the numbers come from?',
        a: 'Revenue from the week you closed, COGS from your Inventory counts, labor from the hours you logged under The Floor, comps from the void and comp log, plus every bill and cash outflow you log on Money Out. The rest of Books is aggregation and formatting, not a second place to capture data.' },
