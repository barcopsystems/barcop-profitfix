...
S.HubPermits = {
  ...
  renderMain() {
    ...
    const addCard = '<div class="card form-card">'
      ...
      +   '<div class="f" style="flex:1 1 150px;min-width:130px;"><label>Name</label><input type="text" id="hpa-name" placeholder="Texas Mixed Beverage Permit"/></div>'
      +   '<div class="f" style="width:190px;"><label>Type</label><select id="hpa-type">' + typeOpts + '</select></div>'
