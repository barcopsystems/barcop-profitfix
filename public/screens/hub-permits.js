...
S.HubPermits = {
  ...
  renderMain() {
    ...
    const addCard = '<div class="card form-card">'
      ...
      +   '<div class="f" style="width:220px;"><label>Type' + App.manageListLink('permit_type') + '</label>' + App.customSelect({ id: 'hpa-type', key: 'permit_type', builtin: this.TYPES }) + '</div>'
  ...
  _openModal(record) {
    ...
    const html = '<div class="card form-card narrow-form" style="margin:0;">'
      ...
      +   '<div class="f"><label>Type' + App.manageListLink('permit_type') + '</label>' + App.customSelect({ id: 'hp-f-type', key: 'permit_type', builtin: this.TYPES, selected: rec.type }) + '</div>'
