...
S.RecoveryPlaybook = {
  ...
  styleTag() {
    return '<style>'
      ...
      + '.pb-rail{flex:0 0 215px;position:sticky;top:24px;padding-top:2px;}'
      ...
      + '.pb-rail-item{display:block;width:100%;text-align:left;background:none;border:none;border-left:2px solid var(--b2);color:var(--t3);font-size:12.5px;font-weight:600;padding:6px 12px;cursor:pointer;line-height:1.3;white-space:nowrap;transition:color .12s,border-color .12s;}'
      ...
      + '.pb-box-steel{background:var(--gold-tint);border:1px solid var(--b-edge);}'
      + '.pb-box-gold{background:var(--gold-tint);border:1px solid var(--gold-tint-bord);}'
      + '.pb-box-red{background:var(--gold-tint);border:1px solid var(--red);}'
      ...
      + '.pb-part{background:var(--gold-tint);border:1px solid var(--b-edge);border-radius:var(--r);padding:14px 16px;}'
