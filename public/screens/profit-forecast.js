...
S.ProfitForecast = {
  ...
  renderMain() {
    ...
    const opexNote = rr.opexLogged ? ''
      : rr.opexShort ? ' You have under a month of operating costs logged, not enough history to project them honestly yet, so this shows profit before operating costs. It fills in as more bills land on Money Out.'
      : ' No operating costs are logged yet, so this shows profit before operating costs; log rent, utilities, and the like on Money Out for a true net profit.';
  ...
  showHowTo() {
    App.showHelpModal('How Profit Forecast Works', [
      ...
      { h: 'Current Pace vs Your Targets', p: ['Current Pace uses your recent prime cost. At Your Targets swaps in your target prime cost from App Settings. The Target Upside up top is the profit difference, the money on the table if you hit your targets. Your Profit Audit ranks where to go and get it. If you are already running better than your targets, that tile reads Ahead of Target and shows by how much instead, which is usually a sign your targets are due a look in App Settings.'] },
      { h: 'Reaching True Profit', p: ['Profit here is sales minus prime cost minus operating costs. If you have not logged operating costs yet, it shows profit before operating costs and tells you so. Log them on Money Out: drop a bank or card statement, or type one in by hand.'] },
