...
S.ShiftCashControl = {
  ...
  showHowTo() {
    App.showHelpModal('How Cash Control Works', [
      ...
      { h: 'History pages', p: ['Cash History in the sidebar holds the full filterable record, split into Cash Drops, Safe Log, and Variances tabs, and its Export PDF saves whichever tab you are on. It is read-only. All logging and editing happens here on the board.'] }
    ]);
  },
