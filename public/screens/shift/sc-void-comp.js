...
S.ShiftVoidComp = {
  ...
  showHowTo() {
    App.showHelpModal('How the Voids / Comps Log Works', [
      ...
      { h: 'The Reason carries the classification', p: ['On a comp, the reason tells Bar Cop whether it is a loss or a policy expense. Service Recovery, Customer Goodwill, Manager Comp, Regular / VIP, and Marketing / Promo are give-aways and feed the Operations Audit. Staff Meal and Shift Drink are policy expense, tracked as cost lines in Books and the Annual Review, not a loss. Pick honestly and the loss read stays real.'] },
  ...
  async confirmDel(id) {
    // K3 — name the record. A void or comp feeds the Operations Audit and the Books
