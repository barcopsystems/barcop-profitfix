...
S.ShiftVoidComp = {
  ...
  showHowTo() {
    App.showHelpModal('How the Void and Comp Log Works', [
      ...
      { h: 'The Reason carries the classification', p: ['On a comp, the reason tells Bar Cop whether it is a loss or a policy expense. Service Recovery, Customer Goodwill, Manager Comp, Regular / VIP, and Marketing / Promo are give-aways and feed Theft Risk. Staff Meal and Shift Drink are policy expense, tracked as cost lines in Books and the Annual Review, not theft. Pick honestly and the theft score stays real.'] },
