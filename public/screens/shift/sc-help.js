  ...
  SECTIONS: [
    { t: 'Getting Started', qa: [
      { q: 'What does Shift Control do?',
        a: 'Shift Control captures the operating week: your imported POS sales (revenue and covers), cash drops, the safe log, drawer variances, voids and comps, maintenance issues, walked tabs, floor incidents, your opening and closing checklists, and your pre-shift line-ups. It is one of three Control systems (Inventory, Labor, Shift) that capture daily operations. Your imported sales are the single source for the weekly revenue number every Recovery system reads. Cash data feeds Over and Short in Profit Recovery and the Profit Audit. Voids and comps feed Loss Prevention. Run Shift Control well and the rest of Bar Cop produces honest numbers without you typing the same data twice.' },
      { q: 'Where do I start?',
      ...
      { q: 'How do I add or fix a past week?',
        a: 'Import it. On Close The Week, step the week selector back to the week you want and drop that week\'s POS sales export. Re-importing a week replaces those days, so correcting a week is just re-importing it. Until a week is imported, the weekly revenue total only sums the days that exist, so the number reads low.' }
    ]},
