...
S.ShiftHelp = {
  ...
  SECTIONS: [
    { t: 'Getting Started', qa: [
      ...
      { q: 'Where do I start?',
        a: 'A little setup, then a weekly habit. To set up, build your opening and closing checklists on Build Checklists and add your registers on Add Registers. Then each week, open the Shift dashboard and import this week\'s POS sales: one "sales by day" export, dropped once, lands the whole week.' },
