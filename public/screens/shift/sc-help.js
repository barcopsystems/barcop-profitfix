...
S.ShiftHelp = {
  ...
  showHowTo() {
    App.showHelpModal('Shift Help and FAQ', [
      { p: ['This page is the full Help and FAQ for Shift Control: importing your weekly POS sales, cash control and reconciliation, the operations logs (voids, comps, walked tabs, maintenance, incidents), checklists, and how Shift feeds the rest of Bar Cop.'] },
  ...
  SECTIONS: [
    { t: 'Getting Started', qa: [
      { q: 'What does Shift Control do?',
        a: 'Shift Control captures the operating week: your imported POS sales (revenue and covers), cash drops, the safe log, drawer variances, voids and comps, maintenance issues, walked tabs, floor incidents, and your opening and closing checklists. It is one of three Control systems (Inventory, Labor, Shift) that capture daily operations. Your imported sales are the single source for the weekly revenue number every Recovery system reads. Cash data feeds Profit Recovery Cash Reconciliation and the Profit Audit. Voids and comps feed Loss Prevention. Run Shift Control well and the rest of Bar Cop produces honest numbers without you typing the same data twice.' },
      { q: 'Where do I start?',
