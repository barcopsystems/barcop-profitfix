  ...
  SECTIONS: [
    ...
    { t: 'Checklists', qa: [
      ...
      { q: 'Can I make station checklists just to print?',
        a: 'Yes. On Checklist Templates, set the type to Print Only and build a free-named list, like Bar Close, Kitchen Open, or Floor Close, for the people working each station off paper. Each one gets its own Export PDF that prints a clean sheet with empty checkboxes and blank Date and Completed By lines. Print Only checklists do not run in the app or save a record; they are purely a printable for the clipboard, separate from the tracked Opening and Closing checklists.' }
    ]},
    { t: 'Connections', qa: [
