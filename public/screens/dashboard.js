  ...
  render(container, actions) {
    ...
    if (latest) {
      ...
      summaryHtml = '<div class="tbl-wrap" style="margin-bottom:18px;"><table class="sum-tbl">'
        ...
        +'<tr><td>Food Cost %</td><td class="'+(foodPct>foodTarget?'neg':'pos')+' val">'+App.fmtPct(foodPct)+'</td><td>'+(prev?App.fmtPct(prev.food?.cost_pct):'—')+'</td><td>'+(avg4full(w=>w.food?.cost_pct)!=null?App.fmtPct(avg4full(w=>w.food?.cost_pct)):'—')+'</td></tr>'
