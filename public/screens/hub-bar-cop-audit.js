...
S.HubBarCopAudit = {
  ...
  _SUB_VOICE: {
    ...
    recovery_action:         { area: 'recovery follow-through',        screen: 'your recovery audits',  good: 'You are working your gaps and they are moving.',    bad: 'Surfaced gaps are sitting without a fix logged.',       fix: 'Work the ranked items on your Profit, Revenue and Cash audits. A gap starts measuring the first time you take a tracked action on it.' },
